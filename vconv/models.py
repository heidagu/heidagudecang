...
VIDEO_CODECS = ["h264", "h265", "av1", "vp9", "copy"]
...
AUDIO_MODES = ["copy", "aac", "opus", "mp3", "none", "extract"]
AUDIO_EXTRACT_EXTS = {"m4a": "aac", "opus": "libopus", "mp3": "libmp3lame"}
...
class ConversionSettings:
    ...
    def validate(self) -> List[str]:
        ...
        if self.quality_mode not in ("crf", "bitrate"):
        ...
        if self.two_pass:
            if self.video_codec not in ("h264", "h265", "vp9"):
                errors.append("两遍编码仅支持 h264/h265/vp9")
        ...
        if (self.audio_mode in ("aac", "opus", "mp3", "extract")
        ...
        if self.audio_mode == "extract" and self.audio_extract_ext not in AUDIO_EXTRACT_EXTS:
            errors.append("音频提取扩展名仅支持 m4a/opus/mp3")
        return errors
